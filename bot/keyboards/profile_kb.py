...
def profile_actions():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🎥 Story qo'shish", callback_data="profile_story")],
...
def profile_edit_fields():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("❤️ Qiziqishlar", callback_data="edit_interests")],
        [InlineKeyboardButton("📝 Bio", callback_data="edit_bio")],
        [InlineKeyboardButton("🎯 Maqsad", callback_data="edit_goal")],
        [InlineKeyboardButton("📍 Manzil", callback_data="edit_city")],
